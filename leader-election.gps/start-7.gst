...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="start-7">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <attr name="$version">
        ...
        <node id="n12">
            <attr name="layout">
                <string>353 307 37 28</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
                <string>597 235 22 14</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
