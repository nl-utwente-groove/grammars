...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="start11">
        <node id="n2">
            <attr name="layout">
                <string>325 105 16 16</string>
            </attr>
        </node>
        <node id="n0">
            <attr name="layout">
        ...
        <node id="n4">
            <attr name="layout">
                <string>574 104 8 16</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>649 104 8 16</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
        ...
        <node id="n1">
            <attr name="layout">
                <string>647 30 8 16</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>498 105 8 16</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
