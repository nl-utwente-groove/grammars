...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="start13">
        <node id="n2">
            <attr name="layout">
        ...
        <node id="n16">
            <attr name="layout">
                <string>498 105 6 14</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
                <string>428 105 12 14</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
                <string>136 29 35 28</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>266 100 12 14</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
                <string>346 103 12 14</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
        ...
        <node id="n8">
            <attr name="layout">
                <string>180 101 12 14</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
                <string>241 28 6 14</string>
            </attr>
        </node>
        <edge to="n3" from="n16">
            <attr name="label">
